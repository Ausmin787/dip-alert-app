          ...
          <AreaChart data={data} margin={{ top: 12, right: 12, left: 0, bottom: 0 }}>
            <defs>
              <linearGradient id="violetFill" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#2D7DFF" stopOpacity={0.32} />
                <stop offset="100%" stopColor="#2D7DFF" stopOpacity={0.01} />
              </linearGradient>
            </defs>
            <XAxis
              dataKey="date"
              tick={{ fill: '#8A97A6', fontSize: 10 }}
            ...
            {ath && (
              <ReferenceLine
                ...
                stroke="#F6C65B"
                strokeDasharray="5 5"
                label={{ value: 'ATH', fill: '#F6C65B', fontSize: 10, position: 'insideTopRight' }}
              />
            )}
            <Area
              type="monotone"
